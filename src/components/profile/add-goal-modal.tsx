...
export default function AddGoalModal({ onAddGoal }: AddGoalModalProps) {
  ...
  const [goalDifficulty, setGoalDifficulty] =
    useState<GoalDifficulty>("moderate");
  ...
  const handleAddGoal = async () => {
    ...
    let userId = await client.auth.getSession();
    const newGoal = {
      title: goalTitle,
      category: goalType,
      target: goalTarget,
      ...
      user_id: userId.data.session?.user.id,
    };
            ...
            >
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="text-xs max-w-xs">
                            Select the type of goal you want to track. This will
                            determine the available units and tracking methods.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-zinc-400">
                        {getDifficultyLabel(goalDifficulty)}
                      </span>
                    </div>
                    <div className="pt-2">
                      <Slider
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                              <p className="text-xs text-zinc-400">
                                Deadline:{" "}
                                {goalDeadline
                                  ? new Date(goalDeadline).toLocaleDateString()
                                  : "Not set"}
                              </p>
                              {goalDeadline && (
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-zinc-400">
                    Select a pre-defined goal template to get started quickly
                  </p>
                </div>
                ...
                {selectedTemplate && (
                  <div className="pt-4 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-zinc-400">
                        Adjust the template to fit your specific needs
                      </p>
                    </div>
