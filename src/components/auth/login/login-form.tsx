          ...
          <div className="p-6 sm:p-8 relative z-10">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.button
                  type="button"
                  className="py-3 px-4 bg-gray-800/80 hover:bg-gray-700/80 rounded-xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 flex items-center justify-center group relative overflow-hidden"
                  whileHover={{ y: -2, boxShadow: "0 10px 15px -3px rgba(37, 99, 235, 0.1)" }}
                  whileTap={{ scale: 0.98 }}
                >
                  ...
                  <span className="text-white text-sm relative z-10">Google</span>
                </motion.button>
                ...
                >
                  ...
                  <span className="text-white text-sm relative z-10">Apple</span>
                </motion.button>
              </div>
